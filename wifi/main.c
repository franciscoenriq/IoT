...
#define WIFI_SSID "iot"   //"VTR-4871545" wifipancho" 
#define WIFI_PASSWORD "12345678"   //"ky3shTsxSthp" "pituca4061" 
#define SERVER_IP     "192.168.4.1" // IP del servidor "192.168.0.4" "192.168.43.20"
