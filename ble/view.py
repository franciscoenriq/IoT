...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.selec_plot1.setItemText(0, _translate("Dialog", "Temperature"))
        self.selec_plot1.setItemText(1, _translate("Dialog", "Hum"))
        self.selec_plot1.setItemText(2, _translate("Dialog", "Amp_x"))
        self.selec_plot1.setItemText(3, _translate("Dialog", "Freq_x"))
        self.selec_plot1.setItemText(4, _translate("Dialog", "Co"))
        self.selec_plot1.setItemText(5, _translate("Dialog", "RMS"))
        self.selec_plot1.setItemText(6, _translate("Dialog", "Press"))
        ...
        self.selec_plot2.setItemText(0, _translate("Dialog", "Temperature"))
        self.selec_plot2.setItemText(1, _translate("Dialog", "Hum"))
        ...
        self.selec_plot3.setItemText(2, _translate("Dialog", "Amp_z"))
        self.selec_plot3.setItemText(3, _translate("Dialog", "Freq_z"))
        self.selec_plot3.setItemText(4, _translate("Dialog", "Co"))
        self.selec_plot3.setItemText(5, _translate("Dialog", "RMS"))
        self.selec_plot3.setItemText(6, _translate("Dialog", "Press"))
